   <header class="nav-wrap">
       <nav class="container nav-inner">
           ...
           <ul class="nav nav-links d-none d-lg-flex">
               <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('home') ? 'active' : '' }}"
                       href="{{ route('home') }}">الرئيسية</a></li>
               <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('about') ? 'active' : '' }}"
                       href="{{ route('about') }}">من نحن</a></li>

               <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('services') ? 'active' : '' }}"
                       href="{{ route('services') }}">خدماتنا</a></li>
               <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('portfolio') ? 'active' : '' }}"
                       href="{{ route('portfolio') }}">أعمالنا</a></li>
               {{--  <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('portfolio') ? 'active' : '' }}" href="{{ route('portfolio') }}">الباقات و العروض</a></li>  --}}
               <li class="nav-item"><a class="nav-link nav-a {{ request()->routeIs('contact') ? 'active' : '' }}"
           ...
           <div class="d-flex align-items-center gap-2">
               ...
               <button class="btn btn-menu d-inline-flex d-lg-none" type="button" data-bs-toggle="offcanvas"
